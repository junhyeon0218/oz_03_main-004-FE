            ...
            <div className='relative h-250 w-[calc(100%-500px)] min-w-627 pt-50'>
                ...
                <div className='mt-15 flex items-center'>
                    ...
                    <button
                        ...
                        className='absolute left-520 top-154 ml-4 h-44 w-101 rounded bg-primary text-white duration-200 hover:scale-105'
                    >
                        Rename
                    </button>
                </div>
                ...
                <div className='mt-15 flex w-520 flex-col'>
                    <div className='ml-3 flex h-55 w-300 items-center justify-between'>
                        <span className='flex items-center'>
                            ...
                            <p className='ml-5 text-20'>Github</p>
                        </span>
                        <button
                            className={`left-535 top-142 ml-4 h-44 w-108 rounded text-16 text-white duration-200 hover:scale-105 ${
                                isGithubConnected ? 'bg-gray-db' : 'bg-primary'
                            }`}
                            onClick={() => !isGithubConnected && handleConnect('Github')}
